...
public class App {
    public static void main(String[] args) {
    	...
    	*/
    	...
    	/* Ejercicio # 1 del Miercoles 10 de Junio.
    	 * Modificar el codigo anterior para si la cadena ha sido encotrada
    	 * que se muestre la posicion, o indice, donde ha sido encontrada */
    	
    	String cadenaABuscar2 = "noska";
    	
    	int indice = 0;
    	
    	if ((indice = sampleCadena.indexOf(cadenaABuscar2)) != -1) 
    		System.out.println("Se ha encontrado la cadena a buscar en el indice: " 
    							+ indice);
    	else 
    		System.out.println("No se ha encontrado la cadena a buscar");
		...
		int indiceEncontrado2 = sampleCadena.toLowerCase()
				.indexOf(cadenaABuscar3.toLowerCase());
